...
ADVANCE_TERRAIN = StandardLookupTable('./database/tables/AdvanceTerrainFactors.csv')
ADVANCE_MINES = InterpolatingLookupTable('./database/tables/AdvanceMines.csv')
ADVANCE_RIVER_FORDABLE = InterpolatingLookupTable('./database/tables/AdvanceRiverFordable.csv')
ADVANCE_RIVER_UNFORDABLE = InterpolatingLookupTable('./database/tables/AdvanceRiverUnfordable.csv')
SHORELINE_FACTORS = StandardLookupTable('./database/tables/ShorelineFactors.csv')